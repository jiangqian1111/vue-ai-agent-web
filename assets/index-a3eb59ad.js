import{x as C,a3 as pt,a4 as O,a5 as i,a6 as I,a7 as le,a8 as Ie,a9 as mt,aa as gt,h as X,ab as Pe,ac as ue,ad as bt,ae as xt,j as S,af as yt,ag as wt,U as Me,M as be,ah as kt,ai as ye,aj as _t,ak as we,E as $,al as $t,am as St,an as Ct,ao as zt,ap as Ae,aq as re,ar as de,as as De,at as Rt,au as Tt,av as Vt,aw as It,ax as Mt,ay as Dt,P as Bt,u as Nt,w as Ut,H as Ee,o as H,k as Q,p as s,D as h,I as p,l,Y as ce,K as k,a0 as N,a1 as U,C as Pt,G as L,az as At,F as Et,V as jt,aA as Ft,y as Y,aB as Ht,aC as je,z as Ot,n as ke,J as _e,aD as Lt,aE as Gt,aF as xe,aG as Kt,aH as Wt}from"./index-23b41248.js";function Be(n){return window.TouchEvent&&n instanceof window.TouchEvent}function Ne(){const n=C(new Map),o=f=>r=>{n.value.set(f,r)};return pt(()=>n.value.clear()),[n,o]}const Yt=O([i("slider",`
 display: block;
 ...
 `)])]),Qt={small:20,medium:18,large:16},Zt=Object.assign(Object.assign({},ue.props),{description:String,stroke:String,size:{type:[String,Number],default:"medium"},show:{type:Boolean,default:!0},strokeWidth:Number,rotate:{type:Boolean,default:!0},spinning:{type:Boolean,validator:()=>!0,default:void 0}}),en=X({name:"Spin",props:Zt,setup(n){const{mergedClsPrefixRef:o,inlineThemeDisabled:f}=Pe(n),r=ue("Spin","-spin",qt,Tt,n,o),v=S(()=>{const{size:d}=n,{common:{cubicBezierEaseInOut:x},self:y}=r.value,{opacitySpinning:b,color:z,textColor:A}=y,j=typeof d=="number"?Vt(d):y[It("size",d)];return{"--n-bezier":x,"--n-opacity-spinning":b,"--n-size":j,"--n-color":z,"--n-text-color":A}}),c=f?ye("spin",S(()=>{const{size:d}=n;return typeof d=="number"?String(d):d[0]}),v,n):void 0;return{mergedClsPrefix:o,compitableShow:Mt(n,["spinning","show"]),mergedStrokeWidth:S(()=>{const{strokeWidth:d}=n;if(d!==void 0)return d;const{size:x}=n;return Qt[typeof x=="number"?"medium":x]}),cssVars:f?void 0:v,themeClass:c==null?void 0:c.themeClass,onRender:c==null?void 0:c.onRender}},render(){var n,o;const{$slots:f,mergedClsPrefix:r,description:v}=this,c=f.icon&&this.rotate,d=(v||f.description)&&$("div",{class:`${r}-spin-description`},v||((n=f.description)===null||n===void 0?void 0:n.call(f))),x=f.icon?$("div",{class:[`${r}-spin-body`,this.themeClass]},$("div",{class:[`${r}-spin`,c&&`${r}-spin--rotate`],style:f.default?"":this.cssVars},f.icon()),d):$("div",{class:[`${r}-spin-body`,this.themeClass]},$(Dt,{clsPrefix:r,style:f.default?"":this.cssVars,stroke:this.stroke,"stroke-width":this.mergedStrokeWidth,class:`${r}-spin`}),d);return(o=this.onRender)===null||o===void 0||o.call(this),f.default?$("div",{class:[`${r}-spin-container`,this.themeClass],style:this.cssVars},$("div",{class:[`${r}-spin-content`,this.compitableShow&&`${r}-spin-content--spinning`]},f),$(Ae,{name:"fade-in-transition"},{default:()=>this.compitableShow?x:null})):x}});function tn(){const n=new Date,o=n.getDate(),f=n.getMonth()+1;return`${n.getFullYear()}-${f}-${o}`}const nn={class:"p-4 space-y-5 min-h-[200px]"},sn={class:"space-y-6"},an={class:"flex items-center space-x-4"},on={class:"flex-shrink-0 w-[100px]"},ln={class:"flex-1"},rn={class:"flex items-center space-x-4"},dn={class:"flex-shrink-0 w-[100px]"},cn={class:"w-[200px]"},un={class:"flex items-center space-x-4"},hn={class:"flex-shrink-0 w-[100px]"},vn={class:"flex-1"},fn={class:"flex-shrink-0 w-[100px]"},pn={class:"flex flex-wrap items-center gap-4"},mn={class:"flex items-center space-x-4"},gn={class:"flex-shrink-0 w-[100px]"},bn={class:"flex flex-wrap items-center gap-4"},xn={class:"flex items-center space-x-4"},yn={class:"flex-shrink-0 w-[100px]"},wn={class:"flex flex-wrap items-center gap-4"},kn={class:"flex items-center space-x-4"},_n={class:"flex-shrink-0 w-[100px]"},$n=X({__name:"General",setup(n){const o=Bt(),f=Nt(),{isMobile:r}=Ut(),v=Ee(),c=S(()=>o.theme),d=S(()=>f.userInfo),x=C(d.value.avatar??""),y=C(d.value.name??""),b=C(d.value.description??""),z=S({get(){return o.language},set(g){o.setLanguage(g)}}),A=[{label:"Auto",key:"auto",icon:"ri:contrast-line"},{label:"Light",key:"light",icon:"ri:sun-foggy-line"},{label:"Dark",key:"dark",icon:"ri:moon-foggy-line"}],j=[{label:"English",key:"en-US",value:"en-US"},{label:"Español",key:"es-ES",value:"es-ES"},{label:"한국어",key:"ko-KR",value:"ko-KR"},{label:"Русский язык",key:"ru-RU",value:"ru-RU"},{label:"Tiếng Việt",key:"vi-VN",value:"vi-VN"},{label:"简体中文",key:"zh-CN",value:"zh-CN"},{label:"繁體中文",key:"zh-TW",value:"zh-TW"}];function G(g){f.updateUserInfo(g),v.success(Y("common.success"))}function J(){f.resetUserInfo(),v.success(Y("common.success")),window.location.reload()}function he(){const g=tn(),_=localStorage.getItem("chatStorage")||"{}",m=JSON.stringify(JSON.parse(_),null,2),E=new Blob([m],{type:"application/json"}),B=URL.createObjectURL(E),D=document.createElement("a");D.href=B,D.download=`chat-store_${g}.json`,document.body.appendChild(D),D.click(),document.body.removeChild(D)}function q(g){const _=g.target;if(!_||!_.files)return;const m=_.files[0];if(!m)return;const E=new FileReader;E.onload=()=>{try{const B=JSON.parse(E.result);localStorage.setItem("chatStorage",JSON.stringify(B)),v.success(Y("common.success")),location.reload()}catch{v.error(Y("common.invalidFileFormat"))}},E.readAsText(m)}function M(){localStorage.removeItem("chatStorage"),location.reload()}function Z(){const g=document.getElementById("fileInput");g&&g.click()}return(g,_)=>(H(),Q("div",nn,[s("div",sn,[s("div",an,[s("span",on,h(g.$t("setting.avatarLink")),1),s("div",ln,[p(l(ce),{value:x.value,"onUpdate:value":_[0]||(_[0]=m=>x.value=m),placeholder:""},null,8,["value"])]),p(l(U),{size:"tiny",text:"",type:"primary",onClick:_[1]||(_[1]=m=>G({avatar:x.value}))},{default:k(()=>[N(h(g.$t("common.save")),1)]),_:1})]),s("div",rn,[s("span",dn,h(g.$t("setting.name")),1),s("div",cn,[p(l(ce),{value:y.value,"onUpdate:value":_[2]||(_[2]=m=>y.value=m),placeholder:""},null,8,["value"])]),p(l(U),{size:"tiny",text:"",type:"primary",onClick:_[3]||(_[3]=m=>G({name:y.value}))},{default:k(()=>[N(h(g.$t("common.save")),1)]),_:1})]),s("div",un,[s("span",hn,h(g.$t("setting.description")),1),s("div",vn,[p(l(ce),{value:b.value,"onUpdate:value":_[4]||(_[4]=m=>b.value=m),placeholder:""},null,8,["value"])]),p(l(U),{size:"tiny",text:"",type:"primary",onClick:_[5]||(_[5]=m=>G({description:b.value}))},{default:k(()=>[N(h(g.$t("common.save")),1)]),_:1})]),s("div",{class:Pt(["flex items-center space-x-4",l(r)&&"items-start"])},[s("span",fn,h(g.$t("setting.chatHistory")),1),s("div",pn,[p(l(U),{size:"small",onClick:he},{icon:k(()=>[p(l(L),{icon:"ri:download-2-fill"})]),default:k(()=>[N(" "+h(g.$t("common.export")),1)]),_:1}),s("input",{id:"fileInput",type:"file",style:{display:"none"},onChange:q},null,32),p(l(U),{size:"small",onClick:Z},{icon:k(()=>[p(l(L),{icon:"ri:upload-2-fill"})]),default:k(()=>[N(" "+h(g.$t("common.import")),1)]),_:1}),p(l(At),{placement:"bottom",onPositiveClick:M},{trigger:k(()=>[p(l(U),{size:"small"},{icon:k(()=>[p(l(L),{icon:"ri:close-circle-line"})]),default:k(()=>[N(" "+h(g.$t("common.clear")),1)]),_:1})]),default:k(()=>[N(" "+h(g.$t("chat.clearHistoryConfirm")),1)]),_:1})])],2),s("div",mn,[s("span",gn,h(g.$t("setting.theme")),1),s("div",bn,[(H(),Q(Et,null,jt(A,m=>p(l(U),{key:m.key,size:"small",type:m.key===l(c)?"primary":void 0,onClick:E=>l(o).setTheme(m.key)},{icon:k(()=>[p(l(L),{icon:m.icon},null,8,["icon"])]),_:2},1032,["type","onClick"])),64))])]),s("div",xn,[s("span",yn,h(g.$t("setting.language")),1),s("div",wn,[p(l(Ft),{style:{width:"140px"},value:l(z),options:j,onUpdateValue:_[6]||(_[6]=m=>l(o).setLanguage(m))},null,8,["value"])])]),s("div",kn,[s("span",_n,h(g.$t("setting.resetUserInfo")),1),p(l(U),{size:"small",onClick:J},{default:k(()=>[N(h(g.$t("common.reset")),1)]),_:1})])])]))}}),Sn={class:"p-4 space-y-5 min-h-[200px]"},Cn={class:"space-y-6"},zn={class:"flex items-center space-x-4"},Rn={class:"flex-shrink-0 w-[120px]"},Tn={class:"flex-1"},Vn={class:"flex items-center space-x-4"},In={class:"flex-shrink-0 w-[120px]"},Mn={class:"flex-1"},Dn={class:"flex items-center space-x-4"},Bn={class:"flex-shrink-0 w-[120px]"},Nn={class:"flex-1"},Un={class:"flex items-center space-x-4"},Pn=s("span",{class:"flex-shrink-0 w-[120px]"}," ",-1),An=X({__name:"Advanced",setup(n){const o=Ht(),f=Ee(),r=C(o.systemMessage??""),v=C(o.temperature??.5),c=C(o.top_p??1);function d(y){o.updateSetting(y),f.success(Y("common.success"))}function x(){o.resetSetting(),f.success(Y("common.success")),window.location.reload()}return(y,b)=>(H(),Q("div",Sn,[s("div",Cn,[s("div",zn,[s("span",Rn,h(y.$t("setting.role")),1),s("div",Tn,[p(l(ce),{value:r.value,"onUpdate:value":b[0]||(b[0]=z=>r.value=z),type:"textarea",autosize:{minRows:1,maxRows:4}},null,8,["value"])]),p(l(U),{size:"tiny",text:"",type:"primary",onClick:b[1]||(b[1]=z=>d({systemMessage:r.value}))},{default:k(()=>[N(h(y.$t("common.save")),1)]),_:1})]),s("div",Vn,[s("span",In,h(y.$t("setting.temperature")),1),s("div",Mn,[p(l(Ue),{value:v.value,"onUpdate:value":b[2]||(b[2]=z=>v.value=z),max:2,min:0,step:.1},null,8,["value","step"])]),s("span",null,h(v.value),1),p(l(U),{size:"tiny",text:"",type:"primary",onClick:b[3]||(b[3]=z=>d({temperature:v.value}))},{default:k(()=>[N(h(y.$t("common.save")),1)]),_:1})]),s("div",Dn,[s("span",Bn,h(y.$t("setting.top_p")),1),s("div",Nn,[p(l(Ue),{value:c.value,"onUpdate:value":b[4]||(b[4]=z=>c.value=z),max:1,min:0,step:.1},null,8,["value","step"])]),s("span",null,h(c.value),1),p(l(U),{size:"tiny",text:"",type:"primary",onClick:b[5]||(b[5]=z=>d({top_p:c.value}))},{default:k(()=>[N(h(y.$t("common.save")),1)]),_:1})]),s("div",Un,[Pn,p(l(U),{size:"small",onClick:x},{default:k(()=>[N(h(y.$t("common.reset")),1)]),_:1})])])]))}}),En="nova-chat",jn="3.0.0",Fn="A modern AI chat portal — powered by Fetch ReadableStream, Vue 3, and TypeScript",Hn="",On=["chatgpt-web","chatgpt","chatbot","vue"],Ln={dev:"vite",build:"vite build",predeploy:"npm run build",deploy:"gh-pages -d dist",preview:"vite preview","build-only":"vite build","type-check":"vue-tsc --noEmit",lint:"eslint .","lint:fix":"eslint . --fix",bootstrap:"pnpm install && pnpm run common:prepare","common:cleanup":"rimraf node_modules && rimraf pnpm-lock.yaml","common:prepare":"husky install"},Gn={"@vscode/markdown-it-katex":"^1.0.3","@vueuse/core":"^9.13.0",dexie:"^4.4.4","highlight.js":"^11.7.0","html-to-image":"^1.11.11",katex:"^0.16.4","markdown-it":"^13.0.1","mermaid-it-markdown":"^1.0.8","naive-ui":"^2.34.3",pinia:"^2.0.33",vue:"^3.2.47","vue-i18n":"^9.2.2","vue-router":"^4.1.6"},Kn={"@antfu/eslint-config":"^0.35.3","@commitlint/cli":"^17.4.4","@commitlint/config-conventional":"^17.4.4","@iconify/vue":"^4.1.0","@types/crypto-js":"^4.1.1","@types/katex":"^0.16.0","@types/markdown-it":"^12.2.3","@types/markdown-it-link-attributes":"^3.0.1","@types/node":"^18.14.6","@vitejs/plugin-vue":"^4.0.0",autoprefixer:"^10.4.13",axios:"^1.3.4","crypto-js":"^4.1.1",eslint:"^8.35.0","gh-pages":"^6.3.0",husky:"^8.0.3",less:"^4.1.3","lint-staged":"^13.1.2","markdown-it-link-attributes":"^4.0.1","npm-run-all":"^4.1.5",postcss:"^8.4.21",rimraf:"^4.3.0",tailwindcss:"^3.2.7",typescript:"~4.9.5",vite:"^4.2.0","vite-plugin-pwa":"^0.14.4","vue-tsc":"^1.2.0"},Wn={name:En,version:jn,private:!0,description:Fn,author:Hn,keywords:On,scripts:Ln,dependencies:Gn,devDependencies:Kn,"lint-staged":{"*.{ts,tsx,vue}":["pnpm lint:fix"]}},Yn={class:"p-4 space-y-5"},Xn={class:"text-center"},Jn=s("h2",{class:"text-xl font-bold text-neutral-800"}," Nova Chat ",-1),qn={class:"text-sm text-neutral-400 mt-1"},Qn=s("div",{class:"p-3 space-y-2 rounded-xl bg-neutral-50 border border-neutral-100"},[s("p",{class:"text-xs font-semibold text-neutral-400 uppercase tracking-wide"},"Tech Stack"),s("div",{class:"flex flex-wrap gap-1.5"},[s("span",{class:"px-2 py-0.5 text-xs rounded-md bg-white border border-neutral-200 text-neutral-600"},"Vue 3"),s("span",{class:"px-2 py-0.5 text-xs rounded-md bg-white border border-neutral-200 text-neutral-600"},"TypeScript"),s("span",{class:"px-2 py-0.5 text-xs rounded-md bg-white border border-neutral-200 text-neutral-600"},"Vite"),s("span",{class:"px-2 py-0.5 text-xs rounded-md bg-white border border-neutral-200 text-neutral-600"},"Pinia"),s("span",{class:"px-2 py-0.5 text-xs rounded-md bg-white border border-neutral-200 text-neutral-600"},"Tailwind CSS"),s("span",{class:"px-2 py-0.5 text-xs rounded-md bg-white border border-neutral-200 text-neutral-600"},"Naive UI"),s("span",{class:"px-2 py-0.5 text-xs rounded-md bg-white border border-neutral-200 text-neutral-600"},"Dexie.js"),s("span",{class:"px-2 py-0.5 text-xs rounded-md bg-white border border-neutral-200 text-neutral-600"},"Fetch + ReadableStream")])],-1),Zn={class:"space-y-2.5"},es={class:"flex items-center justify-between text-sm"},ts={class:"text-neutral-400"},ns={class:"font-mono text-neutral-600"},ss={key:0,class:"flex items-center justify-between text-sm"},as={class:"text-neutral-400"},os={class:"font-mono text-neutral-600"},is={key:1,class:"flex items-center justify-between text-sm"},ls={class:"text-neutral-400"},rs={class:"font-mono text-neutral-600"},ds={class:"flex items-center justify-between text-sm"},cs={class:"text-neutral-400"},us={class:"font-mono text-neutral-600"},hs=X({__name:"About",setup(n){const o=je(),f=C(!1),r=C(),v=S(()=>!!o.isChatGPTAPI);async function c(){try{f.value=!0;const{data:d}=await Lt();r.value=d}finally{f.value=!1}}return Ot(()=>{c()}),(d,x)=>(H(),ke(l(en),{show:f.value},{default:k(()=>{var y,b,z,A;return[s("div",Yn,[s("div",Xn,[Jn,s("p",qn," v"+h(l(Wn).version)+" · MIT ",1)]),Qn,s("div",Zn,[s("div",es,[s("span",ts,h(d.$t("setting.api")),1),s("span",ns,h(((y=r.value)==null?void 0:y.apiModel)??"-"),1)]),l(v)?(H(),Q("div",ss,[s("span",as,h(d.$t("setting.monthlyUsage")),1),s("span",os,h(((b=r.value)==null?void 0:b.usage)??"-"),1)])):_e("",!0),l(v)?_e("",!0):(H(),Q("div",is,[s("span",ls,h(d.$t("setting.reverseProxy")),1),s("span",rs,h(((z=r.value)==null?void 0:z.reverseProxy)??"-"),1)])),s("div",ds,[s("span",cs,h(d.$t("setting.timeout")),1),s("span",us,h(((A=r.value)==null?void 0:A.timeoutMs)??"-")+"ms",1)])])])]}),_:1},8,["show"]))}}),vs={class:"ml-2"},fs={class:"min-h-[100px]"},ps={class:"ml-2"},ms={class:"min-h-[100px]"},gs={class:"ml-2"},xs=X({__name:"index",props:{visible:{type:Boolean}},emits:["update:visible"],setup(n,{emit:o}){const f=n,r=je(),v=S(()=>!!r.isChatGPTAPI),c=C("General"),d=S({get(){return f.visible},set(x){o("update:visible",x)}});return(x,y)=>(H(),ke(l(Wt),{show:l(d),"onUpdate:show":y[1]||(y[1]=b=>Kt(d)?d.value=b:null),"auto-focus":!1,preset:"card",style:{width:"95%","max-width":"640px"}},{default:k(()=>[s("div",null,[p(l(Gt),{value:c.value,"onUpdate:value":y[0]||(y[0]=b=>c.value=b),type:"line",animated:""},{default:k(()=>[p(l(xe),{name:"General",tab:"General"},{tab:k(()=>[p(l(L),{class:"text-lg",icon:"ri:file-user-line"}),s("span",vs,h(x.$t("setting.general")),1)]),default:k(()=>[s("div",fs,[p($n)])]),_:1}),l(v)?(H(),ke(l(xe),{key:0,name:"Advanced",tab:"Advanced"},{tab:k(()=>[p(l(L),{class:"text-lg",icon:"ri:equalizer-line"}),s("span",ps,h(x.$t("setting.advanced")),1)]),default:k(()=>[s("div",ms,[p(An)])]),_:1})):_e("",!0),p(l(xe),{name:"Config",tab:"Config"},{tab:k(()=>[p(l(L),{class:"text-lg",icon:"ri:list-settings-line"}),s("span",gs,h(x.$t("setting.config")),1)]),default:k(()=>[p(hs)]),_:1})]),_:1},8,["value"])])]),_:1},8,["show"]))}});export{xs as default};
